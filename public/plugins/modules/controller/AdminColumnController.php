...
class AdminColumnController extends PluginAdminBaseController
{
    ...
    public function index()
    {
        ...
        foreach ($result as $key => $value) {
            ...
            $result[$key]['str_manage']     = '<a href="' . cmf_plugin_url('Modules://AdminColumn/add', ["parent" => $value['id'], "modules_id" => $this->modules_id])
                . '">添加子栏目</a> | <a href="' . cmf_plugin_url('Modules://AdminColumn/edit', ["id" => $value['id'],'modules_id'=>$this->modules_id])
                . '">编辑</a> | <a class="js-ajax-delete" href="' . cmf_plugin_url('Modules://AdminColumn/delete', ["id" => $value['id'],'modules_id'=>$this->modules_id]) . '">删除</a> ';
            ...
            $result[$key]['modules']         = $value['modules_id'] ? $newModules[$value['modules_id']] : '未绑定模块';
    ...
    public function add()
    {
        ...
        $categoriesTree      = $this->model->ColumnTree($parentId);
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            ...
            $ColumnTree      = $this->model->ColumnTree($category['parent_id'], $id);
...
tpl;
        $categoryTree = $this->model->adminColumnTableTree($selectedIds, $tpl,$modulesId, $parent_id);
