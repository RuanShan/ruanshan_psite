;(function () {
    ...
    if (ajaxForm_list.length) {
        ...
        Wind.use('ajaxForm', 'artDialog', 'noty', 'validate', function () {
            var $btn;
            $('form.js-ajax-form').on('click','button.js-ajax-submit', function (e) {
            //$('button.js-ajax-submit').on('click', function (e) {//LI-修改
            ...
            ajaxForm_list.each(function () {
                $(this).validate({
                    ...
                    submitHandler: function (form) {
                        var $form = $(form);
                        $form.ajaxSubmit({
                            url: $btn!==undefined && $btn.data('action') ? $btn.data('action') : $form.attr('action'), //按钮上是否自定义提交地址(多按钮情况)
                            dataType: 'json',
                            ...
                            error: function (xhr, e, statusText,data) {
                                art.dialog({
                                    id: 'warning',
                                    icon: 'warning',
                                    content: statusText,
