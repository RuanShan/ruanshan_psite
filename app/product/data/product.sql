...
--
-- 表的结构 `cmf_product_category`
--

CREATE TABLE IF NOT EXISTS `cmf_product_category` (
...
--
-- 表的结构 `cmf_product_category_post`
--

CREATE TABLE IF NOT EXISTS `cmf_product_category_post` (
...
--
-- 表的结构 `cmf_product_post`
--

CREATE TABLE IF NOT EXISTS `cmf_product_post` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='product应用 产品表' ROW_FORMAT=COMPACT;

-- --------------------------------------------------------

--
-- 表的结构 `cmf_product_tag`
--

CREATE TABLE IF NOT EXISTS `cmf_product_tag` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '1' COMMENT '状态,1:发布,0:不发布',
  `recommended` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '是否推荐;1:推荐;0:不推荐',
...
--
-- 表的结构 `cmf_product_tag_post`
--

CREATE TABLE IF NOT EXISTS `cmf_product_tag_post` (
...
-- 增缩略图字段
ALTER TABLE `cmf_product_post` ADD `thumbnail` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '缩略图' AFTER `post_source`;
ALTER TABLE `cmf_product_post` ADD `post_favorites` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '收藏数' AFTER `post_hits`;
