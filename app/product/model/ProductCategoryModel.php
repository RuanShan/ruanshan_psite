    ...
    public function addCategory($data)
    {
        ...
        if ($result != false) {
            ...
            if (!empty($data['alias']) && !empty($id)) {
                ...
                $routeModel->setRoute($data['alias'] . '/:id', 'product/Item/index', ['cid' => $id], 2, 4999);
            }
    ...
    public function editCategory($data)
    {
        ...
        if (empty($oldCategory) || empty($newPath)) {
            ...
            if (!empty($data['alias'])) {
                ...
                $routeModel->setRoute($data['alias'] . '/:id', 'product/Item/index', ['cid' => $data['id']], 2, 4999);
            } else {
                $routeModel->deleteRoute('product/List/index', ['id' => $data['id']]);
                $routeModel->deleteRoute('product/Item/index', ['cid' => $data['id']]);
            }
