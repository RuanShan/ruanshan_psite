...
use app\portal\service\PostServicePro;
...
class AdminProductController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $postService = new PostServicePro();
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $portalPostModel = new PortalProductModel();
            ...
            $this->success('添加成功!', url('AdminProduct/edit', ['id' => $portalPostModel->id]));
        }
